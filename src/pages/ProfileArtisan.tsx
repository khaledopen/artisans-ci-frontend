...
import { Loader2, CheckCircle, AlertCircle, User, MapPin, Mail, Briefcase, Camera, Phone } from "lucide-react";
...
const ProfileArtisan = () => {
    ...
    const fetchUser = async () => {
      ...
      try {
        ...
        setForm({
          ...
          numero: user.numero || storedUser.numero || "",
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ✅ L'ID est inclus dans l'objet envoyé
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8 text-center">
              <div className="w-24 h-24 rounded-full bg-white/20 flex items-center justify-center mx-auto mb-4">
                {form.photoprofil ? (
                  <img src={form.photoprofil} alt="profil" className="w-24 h-24 rounded-full object-cover" />
                ) : (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 focus:border-blue-400 outline-none transition"
                      />
                    </div>
                  </div>
                  <div>
